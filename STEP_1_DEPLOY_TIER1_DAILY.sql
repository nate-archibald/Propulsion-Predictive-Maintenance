-- ============================================================================
-- STEP 1: Deploy Tier 1 Daily Materialized Views (6 views)
-- Refresh: Daily at 7:00 AM UTC
-- ============================================================================
-- Execute this first, wait for completion (~15 min), then run Step 2

-- Set variables for catalog, schema, and bronze schema
-- These should match your Databricks configuration
...
SELECT '${catalog}' as catalog, '${an_maintenanceengineering_ods}' as silver_schema, '${bronze_schema}' as bronze_schema;

-- ============================================================================
-- TIER 1 DAILY: 6 Materialized Views @ 7:00 AM UTC
-- ============================================================================
...
-- ============================================================================
-- VERIFICATION: Check Tier 1 Daily MVs Created Successfully
-- ============================================================================
SELECT 
  name,
  kind,
